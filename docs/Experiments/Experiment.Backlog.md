...
| `Experiment.RealtimeVolitionReadOnlyInspection` | High | Running | Can the realtime model call `inspect_volition_state` and `select_volition_goals` tools to explain active goals and arbitration results in a live voice session? |
