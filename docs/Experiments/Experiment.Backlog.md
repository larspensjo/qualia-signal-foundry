...
| `Experiment.RealtimeVolitionContextInjection` | High | Running | Does injecting a compact, trace-backed volition context packet before `response.create` subtly steer responses toward active goals without displacing user intent? |
