...
input or internal event
  ...
  -> goal evaluator updates active goal salience
...
### Phase 3: Goal Salience Updates

Let events activate or weaken existing goals.

Test:

- repeated open questions increase salience
- resolved questions lower salience
...
external action. Exact goal content should remain open until an experiment needs a
specific fixture.
