...
| VolitionContextPacket | A compact packet planned for injection before realtime `response.create`, containing selected goal context and trace fields. | ambient motivational context | Designed next; not started |
