...
| Admitted memory candidate | A candidate that passed the relevance gate, including one omitted because the retrieval limit was reached. | A gate reject is not admitted and has no admission basis; admission alone does not imply injection. |
